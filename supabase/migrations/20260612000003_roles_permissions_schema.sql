-- Migration: 004_roles_permissions_schema.sql
...
-- Now add the role_id constraint to store_members (deferred until roles table exists)
-- This was referenced in 003_stores_schema.sql
